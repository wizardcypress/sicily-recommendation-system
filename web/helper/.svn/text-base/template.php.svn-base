...
function create_headline($display) {
	return "<span class='hord_headline'>$display</span>";
}

function create_event($display, $js_callback, $title = "") {
    return "<a href='javascript:void(0)' title='$title' class='hord_link' onclick='$js_callback;return false'>$display</a>";
}
